...
import 'package:cviewer_frontend/domain/repositories/auth_repository.dart'
    as _i7;
import 'package:cviewer_frontend/domain/repositories/cv_repository.dart' as _i8;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i6.FileCViewerService>(
    ...
    gh.factory<_i8.CVRepository>(
      () => realAssemble.cvRepository(
        gh<_i5.CViewerService>(),
        gh<_i6.FileCViewerService>(),
      ),
      registerFor: {
        _dev,
        _prod,
